const menuPage = (containerTag) => {
    ...
    div1.innerHTML = `<p><font size="+2"><strong>Breakkie</strong></font></p>
                      <p>Grounding oatmeal:</p>`
    div1.id = "body-item1";
    ...
    div2.innerHTML = `<p><font size="+2"><strong>Lunch</strong></font></p>
                      <p>Protein bowl:</p>`
    div2.id = "body-item2";
    ...
    div3.innerHTML = `<p><font size="+2"><strong>Dinner</strong></font></p>
                      <p>Lentil Dahl:</p>`
    div3.id = "body-item3";
