...
const contactPage = (containerTag) => {
    ...
    div1.innerHTML = `<p><font size="+2"><strong>Our Contacts</strong></font></p><br>
    <p>Phone: 666-333-555</p><br>
    <p>E-mail: piccolomondo@info.com</p>`
    div1.id = "body-item1";

    const div2 = document.createElement("div");
    div2.innerHTML = `<p><font size="+2"><strong>Write to us</strong></font></p>
    <p>We would be happy to hear from you for any inquiry you might have:</p><br>
    <a href="https://www.theodinproject.com/">piccolomondo@info.com</a>`
    div2.id = "body-item2";

    const div3 = document.createElement("div");
    div3.innerHTML = `<p><font size="+2"><strong>Location</strong></font></p>`
    div3.id = "body-item3";
